...
type Row struct {
	state              protoimpl.MessageState  `protogen:"open.v1"`
	ColumnValues       map[string]*ColumnValue `protobuf:"bytes,1,rep,name=ColumnValues,proto3" json:"ColumnValues,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
var file_v1_node_proto_rawDesc = string([]byte{
